        ...
        <div>
            <div class="container d-flex flex-column min-vh-100 justify-content-center">
                <div class="text-white rounded text-center p-3 mb-3 mx-2 mt-0" style="background-color: #115D8C; padding-top:15px;">
                    <span class="fw-bold">Editar Aluno</span>
                </div>
                <?php
                $select = "select id,nome,email,senha from tb_aluno where id ='$id'";
                ...
                ?>
                    ...
                    <form action="editaAluno" method="post" class="form-floating">
                        ...
                        <div class="m-2">
                            <div class="row g-2 mb-5">
                                ...
                                <div class="col-md mx-4">
                                    <div class="form-floating">
                                        <input type="text" class="form-control border-0 border-bottom border-secondary" name="tipo" id="optionn-1" value="Aluno" disabled>
...
if (isset($_POST['salvar'])) {
    ...
    $id = $_POST['id'];
    // echo $id;
    $update = "update tb_aluno set nome = '$nome1', email = '$email1'
        ,senha = '$senha1' where id = '$id' ;";
