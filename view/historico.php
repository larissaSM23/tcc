...
<body>
        ...
        <div>
            ...
            ?>
                        ...
                        <div class="border-pink mb-3 p-3">
                            ...
                            <a class="link-dark link-underline-none dropdown-toggle float-end" data-toggle="collapse" href="#" role="button" data-target="#answer-<?php echo $id_aluno_atividade; ?>" id="exercicio-<?php echo $id_aluno_atividade; ?>" data-content="Clique aqui para ver sua resposta" rel="popover" data-placement="right" data-trigger="hover">Ver resposta</a>
    ...
    $id_sessao = $_SESSION['cpf'];
    if ($id_sessao) {
        $resposta_select = "select b.id as id_aluno_atividade from tb_aluno a, tb_aluno_atividade b, tb_atividade c where a.id=b.id_aluno and b.id_atividade=c.id and a.cpf='$id_sessao';";
        $query  = mysqli_query($connection, $resposta_select);
        
        while($linha = mysqli_fetch_array($query)){
            $id_aluno_atividade = $linha['id_aluno_atividade'];
           ?> 
    <script>$('#exercicio-<?php echo $id_aluno_atividade; ?>').popover();</script>
<?php
        }
    }
    ?>
